...
@section('content')
    <div class="card" data-testid="screen-dm">
        ...
        <p>件数: {{ $rows->count() }} / <a class="button secondary" href="/dm.csv?{{ http_build_query(request()->query()) }}">CSVへ書き出す</a></p>
        ...
        <table>
            ...
            <tbody>
                ...
                @empty
                    <tr data-testid="empty-dm"><td colspan="4" class="empty">対象がありません。</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
