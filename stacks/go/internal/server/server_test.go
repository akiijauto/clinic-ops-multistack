...
func newTestHandler(t *testing.T) http.Handler {
	...
	return New(config.Config{}, log, views, assets.Handler(), assets.UICSSHandler(), nil, nil, nil, nil).Handler()
}
...
func TestRoutesAreRecorded(t *testing.T) {
	s := New(config.Config{}, slog.New(slog.NewTextHandler(io.Discard, nil)), nil, nil, nil, nil, nil, nil, nil)
	s.Handler()
